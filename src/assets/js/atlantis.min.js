...
$(".nav-search .input-group > input").focus(function(s) {
    ...
    $(".btn-refresh-card").on("click", function() {
        ...
        s.length && (s.addClass("is-loading"), setTimeout(function() {
    ...
    if (!h) {
        ...
        C.on("click", function() {
            1 == u ? ($("html").removeClass("quick_sidebar_open"), $(".quick-sidebar-overlay").remove(), C.removeClass("toggled"), h = 0) : ($("html").addClass("quick_sidebar_open"), C.addClass("toggled"), $('<div class="quick-sidebar-overlay"></div>').insertAfter(".quick-sidebar"), h = 1)
    ...
    if (!g) {
        ...
        $(".wrapper").hasClass("sidebar_minimize") && (v = 1, w.addClass("toggled"), w.html('<i class="icon-options-vertical"></i>')), w.on("click", function() {
            1 == v ? ($(".wrapper").removeClass("sidebar_minimize"), w.removeClass("toggled"), w.html('<i class="icon-menu"></i>'), v = 0) : ($(".wrapper").addClass("sidebar_minimize"), w.addClass("toggled"), w.html('<i class="icon-options-vertical"></i>'), v = 1), $(window).resize()
        }), g = !0
    }
    if (!p) {
